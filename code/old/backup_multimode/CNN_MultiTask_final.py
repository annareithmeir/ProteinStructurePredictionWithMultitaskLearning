...
if(MULTITASK_MODE=='multi4'):
    model=Networks.MultiCNN(INPUT_MODE, DSSP_MODE, True).to(device)
else:
    model = Networks.MultiCNN(INPUT_MODE, DSSP_MODE, False).to(device)
...
for epoch in range(NUM_EPOCHS):
    ...
    if (DSSP_MODE == 8 and MAP_TO_DSSP3):
