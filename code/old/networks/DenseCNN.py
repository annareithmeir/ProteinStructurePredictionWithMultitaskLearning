...
model=NetworksExtended.MultiTargetDenseNet(INPUT_MODE, DSSP_MODE, MULTITASK_MODE).to(device)
...
pipeline=MultiTargetPredictionPipelineExtended.Pipeline(DSSP_MODE, device, model, opt, criterions, False, MULTITASK_MODE)
