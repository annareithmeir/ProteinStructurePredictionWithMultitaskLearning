...
#
# This file is the LSTM model and takes the following arguments when being called:
...
model=Networks.LSTM(INPUT_MODE, DSSP_MODE,MULTITASK_MODE, 34, 32, 2,device).to(device)
