...
DSSP_MODE=3       #3 or 8
N_SPLITS_KFOLD=3
LOG_PATH='log/Structure/biLSTM_'+INPUT_MODE+'_'+str(DSSP_MODE)+'_structure'
STATS_PATH='stats'
...
model=Networks.MultibiLSTM(INPUT_MODE, DSSP_MODE, 6, 32, 1,device).to(device)
...
torch.save(model.state_dict(), LOG_PATH+'/bi_lstm_structure.ckpt')
