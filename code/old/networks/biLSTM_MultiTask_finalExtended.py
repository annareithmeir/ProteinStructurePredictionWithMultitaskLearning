...
import NetworksExtended
import DataLoader
import MultiTargetPredictionPipelineExtended
import utilities
...
model=NetworksExtended.MultibiLSTM(INPUT_MODE, DSSP_MODE, MULTITASK_MODE, 10, 32, 2,device).to(device)
...
pipeline=MultiTargetPredictionPipelineExtended.Pipeline(DSSP_MODE, device, model, opt, criterions, True, MULTITASK_MODE)
