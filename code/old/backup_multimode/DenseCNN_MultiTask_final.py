...
model=Networks.MultiTargetDenseNet(INPUT_MODE, DSSP_MODE).to(device)
...
assert(len(inputs)==len(masks_struct3)==len(targets_structure3)==len(targets_solvAcc)==len(targets_flexibility))
