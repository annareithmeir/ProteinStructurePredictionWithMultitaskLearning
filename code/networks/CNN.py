...
#
# This file is the CNN model and takes the following arguments when being called:
...
model=Networks.CNN(INPUT_MODE, DSSP_MODE, MULTITASK_MODE).to(device)
...
for epoch in range(NUM_EPOCHS):
    ...
    print('TRAIN LOSS:',round(train_loss_epoch[3], 3))#Loss organized in array
