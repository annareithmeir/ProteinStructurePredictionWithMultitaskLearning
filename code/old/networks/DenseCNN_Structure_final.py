...
DSSP_MODE=3       #3 or 8
N_SPLITS_KFOLD=3
LOG_PATH='log/Structure/DenseCNN_'+INPUT_MODE+'_'+str(DSSP_MODE)+'_structure'
STATS_PATH='stats'
...
model=Networks.MultiTargetDenseNet(INPUT_MODE).to(device)
...
torch.save(model.state_dict(), LOG_PATH+'/dense_cnn_structure.ckpt')