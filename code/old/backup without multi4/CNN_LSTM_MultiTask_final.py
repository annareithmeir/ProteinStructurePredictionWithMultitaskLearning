...
if(DSSP_MODE==8 and MAP_TO_DSSP3=='True'):
    LOG_PATH='log/'+MULTITASK_MODE+'/'+str(DSSP_MODE)+'_mapped/Hybrid_'+INPUT_MODE+'_'+str(DSSP_MODE)+'_multitarget'
else:
    LOG_PATH = 'log/'+MULTITASK_MODE+'/' + str(DSSP_MODE) + '/Hybrid_' + INPUT_MODE + '_' + str(DSSP_MODE) + '_multitarget'
STATS_PATH='stats'
