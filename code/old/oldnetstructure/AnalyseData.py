...
def analyseDataPredicted():
    f = open('/home/areithmeier/log/multi4/3/DenseHybrid_protvec+scoringmatrix_3_multitarget/dataAnalysisPredicted.txt', 'w')
    dict = np.load('/home/areithmeier/log/multi4/3/DenseHybrid_protvec+scoringmatrix_3_multitarget/predictedData.npy').item()
